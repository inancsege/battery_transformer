...
from utils import SOHTCN, load_and_proc_data, monitor_idle_gpu_cpu, train_model, evaluate_model
...
train_model(model, train_loader, val_loader, criterion, optimizer, "models/best_TCN.pth", device, num_epochs=20)
...
evaluate_model(model, test_loader, "models/best_TCN.pth", 'outputs/error_results_TCN.txt', device)

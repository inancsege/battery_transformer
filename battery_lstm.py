...
from utils import SOHLSTM, load_and_proc_data, monitor_idle_gpu_cpu, train_model, evaluate_model
...
train_model(model, train_loader, val_loader, criterion, optimizer, "models/best_LSTM.pth", device, num_epochs=50)
...
monitoring = True
monitor_thread = threading.Thread(target=monitor_gpu, args=('outputs/log_testing_LSTM.csv', 0.001), daemon=True)
monitor_thread.start()

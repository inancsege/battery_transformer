...
train_model(model, train_loader, val_loader, criterion, optimizer, "models/best_CNN.pth", device, num_epochs=200)
...
evaluate_model(model, test_loader, "models/best_CNN.pth", 'outputs/error_results_CNN.txt', device)
